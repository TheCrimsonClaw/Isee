...
public class Player : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        switch (inventory[powerActiveValue])
        {
            ...
            case PowerTypes.invisibility:
                GUI.Label(new Rect(Screen.width - 205, 35, 200, 30), "Invisibility");
                break;
        ...
        switch (collision.collider.gameObject.tag)
        {
            case "BloodDroplet":
                ...
                if (bloodAudioPlay < bloodSounds.Length)
                {
                    ...
                    StartCoroutine(createSound(bloodSounds[bloodAudioPlay]));
                    bloodAudioPlay++;
                }
    ...
    private IEnumerator createSound(AudioClip clip)
    {
